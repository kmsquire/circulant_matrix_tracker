...
"""
    ...
    ground_truth = pylab.loadtxt(text_files[0], delimiter=",")
    #f.close()
    ...
    if text_files:
        ...
        frames = pylab.loadtxt(text_files[0], delimiter=",", dtype=int)
        #f.close()
...
"""
    ...
    print("should_resize_image "+str(should_resize_image))
